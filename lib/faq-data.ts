export const FAQ_ITEMS = [
  {
    q: "Jak długo trzyma się hybryda?",
    a: "Hybryda utrzymuje się 2–3 tygodnie przy prawidłowej pielęgnacji. Czas noszenia zależy od tempa wzrostu paznokci i dbałości o dłonie.",
  },
  {
  ...
  {
    q: "Jak umówić wizytę?",
    a: "Możesz umówić się telefonicznie, przez formularz kontaktowy lub social media.",
  },
  {
  ...
  },
  {
    ...
    a: "Przyjmujemy gotówkę, płatności kartą oraz BLIK.",
  },
  {
    q: "Czy macie parking?",
  ...
  },
  {
    ...
    a: "Nie musisz specjalnie się przygotowywać. Jeśli masz hybrydy lub żel, możemy je bezpiecznie zdjąć przed nową stylizacją.",
  },
  {
