...
export const metadata: Metadata = {
  ...
  title: {
    default: "BASE STUDIO — Stylizacja paznokci",
    template: "%s | BASE STUDIO",
  },
  description:
    "Stylizacja paznokci. Manicure, hybryda, żel i zdobienia. Umów wizytę ☎️",
  keywords: [
  ...
  openGraph: {
    ...
    title: "BASE STUDIO — Stylizacja paznokci",
    description:
